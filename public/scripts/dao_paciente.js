...
DAOPaciente.prototype.abrirDB = function(callback) {
  //
  // Inicialização
  //
...
DAOPaciente.prototype.obterPacientes = function(callback) {
  fnColocarEspera();
  this.arrayPacientes = [];
  try {
...
DAOPaciente.prototype.incluir = function(
  cpfNovo,
  nomeNovo,
  celularNovo,
  emailNovo,
...
DAOPaciente.prototype.alterar = function(
  cpfAntigo,
  cpfNovo,
  nomeNovo,
  celularNovo,
...
DAOPaciente.prototype.excluir = function(cpfExclusao) {
  fnColocarEspera();
  this.transacao = this.db.transaction(["Paciente"], "readwrite");
  this.transacao.oncomplete = event => {
...
DAOPaciente.prototype.validarCpf = function(strCpf) {
  let soma;
  let resto;
  let i;

...
ViewPaciente.prototype.init = function() {
  this.daoPaciente.abrirDB(this.solicitarObjs);
}

//-----------------------------------------------------------------------------------------//

ViewPaciente.prototype.solicitarObjs = function() {
  this.arrayPacientes = this.daoPaciente.obterPacientes(this.receberObjs);
}

//-----------------------------------------------------------------------------------------//

ViewPaciente.prototype.receberObjs = function(array) {
...
ViewPaciente.prototype.incluir = function() {
...
ViewPaciente.prototype.alterar = function() {
  if (this.operacao == "Navegar") {
    this.inabilitarBotoes();
...
ViewPaciente.prototype.excluir = function() {
  if (this.operacao == "Navegar") {
    this.inabilitarBotoes();
...
ViewPaciente.prototype.salvar = function() {
  let commit = false;
...
ViewPaciente.prototype.primeiro = function() {
  this.posAtual = 0;
  this.atualizarInterface();
}
...
ViewPaciente.prototype.anterior = function() {
  this.posAtual--;
  this.atualizarInterface();
}
...
ViewPaciente.prototype.proximo = function() {
  this.posAtual++;
  this.atualizarInterface();
}
...
ViewPaciente.prototype.ultimo = function() {
...
ViewPaciente.prototype.cancelar = function() {
  this.atualizarInterface();
}

//-----------------------------------------------------------------------------------------//

ViewPaciente.prototype.sair = function() {
  history.back();
}

//-----------------------------------------------------------------------------------------//

ViewPaciente.prototype.restaurarFuncoes = function() {
...
ViewPaciente.prototype.inabilitarBotoes = function() {
...
//-----------------------------------------------------------------------------------------//
ViewPaciente.prototype.atualizarInterface = function() {
